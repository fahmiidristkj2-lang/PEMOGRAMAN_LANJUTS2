...
namespace TugasPemrograman
{
    public partial class Form1 : Form
    {
        ...
        // List untuk menyimpan history tiap langkah algoritma
        ...
        // Array buat mencatat rekor efisiensi algoritma
        int[] hasilPerbandingan = new int[4];
        int[] hasilPertukaran = new int[4];

        // Timer untuk menjalankan fitur Auto Play
        ...
        // untuk menyimpan snapshot data & warna di tiap langkah
        ...
        // untuk mengupdate tampilan tabel sesuai posisi langkah
        void TampilkanDataGrid(int langkah)
        {
            if (stepsNilai.Count == 0) return;

            /* KODING LAMA (scroll Melompat karena barisnya dihapus total):
            dgvData.Rows.Clear();
            ...
            */
            ...
            // KODING BARU: Update nilai sel tanpa hapus baris biar scroll aman
        ...
        // Mengembalikan data ke posisi semula (supaya acak)
        void ResetData()
        {
        ...
        // BUBBLE SORT: Geser elemen terbesar ke kanan dengan menukar elemen bersebelahan/berdampingan
        ...
        // SELECTION SORT: Cari elemen terkecil, lalu taruh paling depan
        void JalankanSelectionSort()
        {
            ...
            for (int i = 0; i < panjang - 1; i++)
            {
                ...
                for (int j = i + 1; j < panjang; j++)
                {
                    ...
                    if (v[j] < v[indexMin])
                    {
                        // menemukan nilai  yang lebih kecil
                        indexMin = j;
        ...
        // INSERTION SORT: Sisipkan elemen ke posisi yang pas secara bertahap
        void JalankanInsertionSort()
        {
            ...
            for (int i = 1; i < panjang; i++)
            {
                ...
                // Geser elemen lain ke kanan untuk memberi ruang
                ...
                // Masukan elemen di ruang yang udah disiapkan
        ...
        // COUNTING SORT: Hitung kemunculan tiap angka, lalu susun tanpa dibandingkan
        void JalankanCountingSort()
        {
            ...
            // Sejajarkan ulang dari hasil perhitungan sorting tadi
        ...
        // SEQUENTIAL SEARCH: Cari data dengan mengecek dari atas sampai bawah
        ...
        // BINARY SEARCH: Cari data dengan membagi dua di tengah (Syarat: Data harus diurutkan terlrbih dulu)
        void JalankanBinarySearch(int nilaiCari)
        {
            ...
            */
            ...
            // Mengurutkan data di balik layar menggunkan  Bubble Sort
            for (int i = 0; i < panjang - 1; i++)
            {
                for (int j = 0; j < panjang - i - 1; j++)
                {
        ...
        void TampilkanTabelPerbandingan()
        {
            ...
            // Cari skor terendah untuk diwarnain hijau
            int minP = int.MaxValue, minT = int.MaxValue, idxP = 0, idxT = 0;
            for (int i = 0; i < 4; i++)
            {
                // Nilai 0 diabaikan supaya adil buat algoritma lain
        ...
        private void dgvPerbandingan_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {

        }

        private void lblPertukaran_Click(object sender, EventArgs e)
        {
